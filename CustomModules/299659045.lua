...
shared.CustomSavegoat = 292439477
if pcall(function() readfile("goat/CustomModules/292439477.lua") end) then
	loadstring(readfile("goat/CustomModules/292439477.lua"))()
else
	local publicrepo = goatGithubRequest("CustomModules/292439477.lua")
	if publicrepo then
